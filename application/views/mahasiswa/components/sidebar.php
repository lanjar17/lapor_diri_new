    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                <li class="nav-item">
                    <a href="<?= base_url();?>Dashboard/dashboard_mahasiswa" class="nav-link">
                        <i class="nav-icon fas fa-tachometer-alt"></i>
                        <p>Dashboard</p>
                    </a>
                </li>
                <li class="nav-item" style="<?php echo  $mahasiswa['nama_lengkap'] == '' ? 'display:none;' : ' ' ?>">
                    <a href="<?= base_url();?>Form_lapor/view_mahasiswa" class="nav-link">
                ...
                <li class="nav-item" style="<?php echo  $mahasiswa['nama_lengkap'] == '' ? 'display:none;' : ' ' ?>">
                    <a href="<?= base_url();?>Form_foto/view_foto" class="nav-link">
                        <i class="nav-icon fas fa-edit"></i>
                        <p>Upload Foto</p>
                    </a>
                </li>
                ...
                <li class="nav-item">
                    <a href="<?= base_url();?>Settings/view_mahasiswa" class="nav-link">
